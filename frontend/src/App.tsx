...
function App() {
  ...
  return <main className="shell">
    ...
    <section className="hero"><div className="eyebrow">FROM LECTURE TO LEARNING</div><h1>Turn every source<br /><em>into something you can study.</em></h1><p className="hero-copy">Capture speech, on-screen text, visual evidence, and the task you actually want—then trace every result back to its source.</p></section>
